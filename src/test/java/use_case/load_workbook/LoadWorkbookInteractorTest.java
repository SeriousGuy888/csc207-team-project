...
public class LoadWorkbookInteractorTest {
    @Test
    void doTheThing() {
        AvailableCoursesDataAccessObject acdao = new AvailableCoursesDataAccessObject(
                List.of("courses/sample_data.json"));
        FileWorkbookDataAccessObject dao = new FileWorkbookDataAccessObject(acdao);
